...
`   },
    ...
    data: {
      media: [
        { type: 'image', src: '/АО-клиент-заказы.png', thumbnail: '/АО-клиент-заказы-small.png' },
      ],
    ...
    data: {
      media: [
        { type: 'image', src: '/АО-клиент-страница-заказа-1.png', thumbnail: '/АО-клиент-страница-заказа-1-small.png' },
        { type: 'image', src: '/АО-клиент-страница-заказа-2.png', thumbnail: '/АО-клиент-страница-заказа-2-small.png' },
      ],
...
`   },
    ...
    data: {
      media: [
        { type: 'image', src: '/Настольное ПО для Аудиторов-1.png', thumbnail: '/Настольное ПО для Аудиторов-1-small.png' },
      ],
...
`   },
    ...
    data: {
      media: [
        { type: 'video', src: '/ao-tg-preview-1.mov', thumbnail: '/АО-ТГ-БОТ-1-small.png' },
        { type: 'image', src: '/АО-ТГ-БОТ-1.png', thumbnail: '/АО-ТГ-БОТ-1-small.png' },
      ],
...
`
    ...
    data: {
      media: [
        { type: 'image', src: '/АО-лендинг-1.png', thumbnail: '/АО-лендинг-1-small.png' },
        { type: 'image', src: '/АО-лендинг-2.png', thumbnail: '/АО-лендинг-2-small.png' },
        { type: 'image', src: '/АО-лендинг-3.png', thumbnail: '/АО-лендинг-3-small.png' },
        { type: 'image', src: '/АО-лендинг-4.png', thumbnail: '/АО-лендинг-4-small.png' },
        { type: 'image', src: '/АО-лендинг-5.png', thumbnail: '/АО-лендинг-5-small.png' },
        { type: 'image', src: '/АО-лендинг-6.png', thumbnail: '/АО-лендинг-6-small.png' },
        { type: 'image', src: '/АО-лендинг-7.png', thumbnail: '/АО-лендинг-7-small.png' },
        { type: 'image', src: '/АО-лендинг-8.png', thumbnail: '/АО-лендинг-8-small.png' },
        { type: 'image', src: '/АО-лендинг-9.png', thumbnail: '/АО-лендинг-9-small.png' },
      ],
...
`   },
    ...
    data: {
      media: [
        { type: 'image', src: '/asamclo-index-1.png', thumbnail: '/asamclo-index-1-small.png' },
        { type: 'image', src: '/asamclo-index-2.png', thumbnail: '/asamclo-index-2-small.png' },
        { type: 'image', src: '/asamclo-index-3.png', thumbnail: '/asamclo-index-3-small.png' },
      ],
    ...
    data: {
      media: [
        { type: 'image', src: '/asamclo-item-1.png', thumbnail: '/asamclo-item-1-small.png' },
        { type: 'image', src: '/asamclo-item-2.png', thumbnail: '/asamclo-item-2-small.png' },
      ],
    ...
    data: {
      media: [
        { type: 'image', src: '/asamclo-checkout-1.png', thumbnail: '/asamclo-checkout-1-small.png' },
        { type: 'image', src: '/asamclo-checkout-2.png', thumbnail: '/asamclo-checkout-2-small.png' },
        { type: 'image', src: '/asamclo-checkout-3.png', thumbnail: '/asamclo-checkout-3-small.png' },
      ],
...
`   },
    ...
    data: {
      media: [
        { type: 'image', src: '/phones-1.png', thumbnail: '/phones-1-small.png' },
        { type: 'image', src: '/phones-2.png', thumbnail: '/phones-2-small.png' },
      ],
    ...
    data: {
      media: [
        { type: 'image', src: '/phones-web-dev-3.png', thumbnail: '/phones-web-dev-3-small.png' },
        { type: 'image', src: '/phones-web-dev-2.png', thumbnail: '/phones-web-dev-2-small.png' },
        { type: 'image', src: '/phones-web-dev-1.png', thumbnail: '/phones-web-dev-1-small.png' },
      ],
